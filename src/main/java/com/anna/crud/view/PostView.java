...
//
//    public void startPosts(Long id_writer) throws ClassNotFoundException, SQLException {
//        System.out.println("Список всех постов: ");
//        printAllPosts(id_writer);
//        int num;
//        boolean end = false;
//
//        do {
...
//
//            if (num == 1) {
//                addNewPost(id_writer);
//            }
//            if (num == 2) {
//                deletePost();
//            }
//            if (num == 3) {
//                updatePost(id_writer);
//            }
//            if (num == 4) {
//                printAllPosts(id_writer);
//            }
...
//        System.out.println("Меню постов автора:" +
//                "\n1 - добавить пост автору;" +
//                "\n2 - удалить пост из списка;" +
//                "\n3 - изменить пост из списка;" +
//                "\n4 - список всех постов автора;" +
//                "\n5 - пост по id of Post;" +
//                "\n6 - завершение работы с постами");
//    }
//
//    private void printAllPosts(Long id) throws ClassNotFoundException, SQLException{
//        for (Post p : postController.getAll()) {
//           if(p.getId_writer().equals(id)) System.out.println(p);
//        }  //getAll
//
//    }
//
//    private void addNewPost(Long id) throws ClassNotFoundException, SQLException{
//
//        Post p = new Post();
//        String content;
//        List<Tag> tags;
...
//
//        postController.save(content,tags,status,id);
//    }
//
...
//    }
//
//    private void updatePost(Long id) throws ClassNotFoundException, SQLException{
...
//        TagView t = new TagView();
//        tags = t.returnPostTags();
//        postController.update(i,c,tags,status,id);
//    }
//
...
//        }
//
//    public List<Post> returnWriterPosts(Long id) throws ClassNotFoundException, SQLException{
//        Long i;
//        boolean flag = true;
